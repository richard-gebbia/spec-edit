...
var _elm_community$intdict$IntDict_Safe$safeWrapper = F2(
	function (k, f) {
		return _elm_lang$core$Basics$not(
			_elm_community$intdict$IntDict$isValidKey(k)) ? _elm_lang$core$Result$Err(_elm_community$intdict$IntDict_Safe$InvalidKey) : _elm_lang$core$Result$Ok(
			f(
				{ctor: '_Tuple0'}));
	});
...
var _user$project$Feature$getId = function (uid) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'feature',
		_elm_lang$core$Basics$toString(uid));
};
var _user$project$Feature$encode = function (_p0) {
	var _p1 = _p0;
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'uid',
				_1: _elm_lang$core$Json_Encode$int(_p1.uid)
			},
				{
				ctor: '_Tuple2',
				_0: 'name',
...
var _user$project$Feature$init = F2(
	function (uid, name) {
		return {uid: uid, name: name, description: ''};
	});
var _user$project$Feature$Model = F3(
	function (a, b, c) {
		return {uid: a, name: b, description: c};
	});
var _user$project$Feature$decoder = A4(
	_elm_lang$core$Json_Decode$object3,
	_user$project$Feature$Model,
...
var _user$project$Feature$DeleteMe = {ctor: 'DeleteMe'};
var _user$project$Feature$EditDesc = function (a) {
	return {ctor: 'EditDesc', _0: a};
};
var _user$project$Feature$EditName = function (a) {
	return {ctor: 'EditName', _0: a};
};
var _user$project$Feature$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('feature')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Events$onClick(_user$project$Feature$DeleteMe),
						_elm_lang$html$Html_Attributes$class('close-button')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('feature-box')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_user$project$Feature$getId(model.uid))
									]),
								_elm_lang$core$Native_List.fromArray(
									[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('feature-name'),
										...
										_elm_lang$html$Html_Events$on,
										'input',
										A2(_elm_lang$core$Json_Decode$map, _user$project$Feature$EditName, _elm_lang$html$Html_Events$targetValue))
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							])),
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$for('descField')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('feature-desc'),
										_elm_lang$html$Html_Attributes$rows(5),
										_elm_lang$html$Html_Attributes$id('descField'),
										_elm_lang$html$Html_Attributes$value(model.description),
										A2(
										_elm_lang$html$Html_Events$on,
										'input',
										A2(_elm_lang$core$Json_Decode$map, _user$project$Feature$EditDesc, _elm_lang$html$Html_Events$targetValue))
									]),
								_elm_lang$core$Native_List.fromArray(
									[]))
							]))
...
var _user$project$Feature$Delete = {ctor: 'Delete'};
var _user$project$Feature$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'EditName':
			...
			default:
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _elm_lang$core$Maybe$Just(_user$project$Feature$Delete)
				};
		}
	});

var _user$project$UndoRedo$subscriptions = function (subFn) {
	return function (_p0) {
		return subFn(
			_elm_lang$core$Basics$fst(
				function (_) {
...
var _user$project$UndoRedo$subMapNew = function (subFn) {
	return function (_p1) {
		return A2(
...
var _user$project$UndoRedo$subLift = function (subFn) {
	return function (_p2) {
		return A2(
			_elm_lang$core$Platform_Sub$map,
			_elm_community$undo_redo$UndoList$New,
...
var _user$project$UndoRedo$view = function (viewFn) {
	return function (_p3) {
		return viewFn(
			_elm_lang$core$Basics$fst(
				function (_) {
...
var _user$project$UndoRedo$update = function (updateFn) {
	var innerUpdate = F2(
		function (msg, undolist) {
			var _p4 = msg;
			switch (_p4.ctor) {
				case 'Reset':
					return {
						ctor: '_Tuple2',
						_0: _elm_community$undo_redo$UndoList$reset(undolist),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Redo':
					return {
						ctor: '_Tuple2',
						_0: _elm_community$undo_redo$UndoList$redo(undolist),
						_1: A2(
							...
							_elm_lang$core$Basics$snd(
								function (_) {
									...
									_elm_community$undo_redo$UndoList$redo(undolist))))
					};
				case 'Undo':
					return {
						ctor: '_Tuple2',
						_0: _elm_community$undo_redo$UndoList$undo(undolist),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'Forget':
					return {
						ctor: '_Tuple2',
						_0: _elm_community$undo_redo$UndoList$forget(undolist),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				default:
					var _p5 = A2(
						updateFn,
						_p4._0,
						_elm_lang$core$Basics$fst(undolist.present));
					var updated = _p5._0;
					var cmd = _p5._1;
					var nextUndoList = A2(
						_elm_community$undo_redo$UndoList$new,
						{ctor: '_Tuple2', _0: updated, _1: cmd},
						undolist);
					return {
						ctor: '_Tuple2',
						_0: nextUndoList,
						_1: A2(_elm_lang$core$Platform_Cmd$map, _elm_community$undo_redo$UndoList$New, cmd)
					};
			}
		});
	return innerUpdate;
};
var _user$project$UndoRedo$init = function (_p6) {
	var _p7 = _p6;
	var _p8 = _p7._1;
	return {
		ctor: '_Tuple2',
		_0: _elm_community$undo_redo$UndoList$fresh(
			{ctor: '_Tuple2', _0: _p7._0, _1: _p8}),
		_1: A2(_elm_lang$core$Platform_Cmd$map, _elm_community$undo_redo$UndoList$New, _p8)
	};
};
var _user$project$UndoRedo$initWithFlags = F2(
	function (initFn, flags) {
		return _user$project$UndoRedo$init(
			initFn(flags));
	});

var _user$project$Spec$checkToDelete = F3(
	function (index, maybeDeleteEvent, features) {
		var _p0 = maybeDeleteEvent;
		if (_p0.ctor === 'Just') {
			return A2(
				_elm_lang$core$Result$withDefault,
				features,
				A2(_elm_community$intdict$IntDict_Safe$safeRemove, index, features));
		} else {
			return features;
		}
	});
var _user$project$Spec$encode = function (_p1) {
	var _p2 = _p1;
	return _elm_lang$core$Json_Encode$object(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				ctor: '_Tuple2',
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$string(_p2.title)
			},
				{
				ctor: '_Tuple2',
				_0: 'nextUid',
				_1: _elm_lang$core$Json_Encode$int(_p2.nextUid)
			},
				{
				ctor: '_Tuple2',
				_0: 'features',
				_1: _elm_lang$core$Json_Encode$list(
					A2(
						_elm_lang$core$List$map,
						_user$project$Feature$encode,
						_elm_community$intdict$IntDict$values(_p2.features)))
			}
			]));
};
var _user$project$Spec$titleId = 'idTitle';
var _user$project$Spec$saveSpec = _elm_lang$core$Native_Platform.outgoingPort(
	'saveSpec',
	function (v) {
		return {filename: v.filename, specJson: v.specJson};
	});
var _user$project$Spec$diffSpec = _elm_lang$core$Native_Platform.outgoingPort(
	'diffSpec',
	function (v) {
		return {filename: v.filename, specJson: v.specJson};
	});
var _user$project$Spec$focus = _elm_lang$core$Native_Platform.outgoingPort(
	'focus',
	function (v) {
		return v;
	});
var _user$project$Spec$loadSpec = _elm_lang$core$Native_Platform.incomingPort('loadSpec', _elm_lang$core$Json_Decode$string);
var _user$project$Spec$saveSpecTrigger = _elm_lang$core$Native_Platform.incomingPort('saveSpecTrigger', _elm_lang$core$Json_Decode$string);
var _user$project$Spec$diffSpecTrigger = _elm_lang$core$Native_Platform.incomingPort('diffSpecTrigger', _elm_lang$core$Json_Decode$string);
var _user$project$Spec$requestRedraw = _elm_lang$core$Native_Platform.incomingPort(
	'requestRedraw',
	_elm_lang$core$Json_Decode$succeed(
		{}));
var _user$project$Spec$undo = _elm_lang$core$Native_Platform.incomingPort(
	'undo',
	_elm_lang$core$Json_Decode$succeed(
		{}));
var _user$project$Spec$redo = _elm_lang$core$Native_Platform.incomingPort(
	'redo',
	_elm_lang$core$Json_Decode$succeed(
		{}));
var _user$project$Spec$Model = F4(
	function (a, b, c, d) {
		return {isEditingTitle: a, features: b, nextUid: c, title: d};
	});
var _user$project$Spec$decoder = function () {
	var featureDecoder = A2(
		_elm_lang$core$Json_Decode$map,
		_elm_community$intdict$IntDict$fromList,
		_elm_lang$core$Json_Decode$list(
			A2(
				_elm_lang$core$Json_Decode$map,
				function (feature) {
					return {ctor: '_Tuple2', _0: feature.uid, _1: feature};
				},
				_user$project$Feature$decoder)));
	return A4(
		_elm_lang$core$Json_Decode$object3,
		_user$project$Spec$Model(false),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'features', featureDecoder),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'nextUid', _elm_lang$core$Json_Decode$int),
		A2(_elm_lang$core$Json_Decode_ops[':='], 'title', _elm_lang$core$Json_Decode$string));
}();
var _user$project$Spec$init = function (json) {
	return A2(
		_elm_lang$core$Result$withDefault,
		{features: _elm_community$intdict$IntDict$empty, nextUid: 0, title: 'Untitled', isEditingTitle: false},
		A2(_elm_lang$core$Json_Decode$decodeValue, _user$project$Spec$decoder, json));
};
var _user$project$Spec$SaveInfo = F2(
	function (a, b) {
		return {filename: a, specJson: b};
	});
		...
		switch (_p3.ctor) {
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							features: function () {
								var newFeature = A2(
									_user$project$Feature$init,
									model.nextUid,
									A2(
										_elm_lang$core$Basics_ops['++'],
										'Feature ',
										_elm_lang$core$Basics$toString(model.nextUid)));
								return A2(
									_elm_lang$core$Result$withDefault,
									model.features,
									A3(_elm_community$intdict$IntDict_Safe$safeInsert, model.nextUid, newFeature, model.features));
							}(),
							...
							features: A2(
								...
								A2(
									...
									function (_p4) {
										var _p5 = _p4;
										return A3(
											_user$project$Spec$checkToDelete,
											_p6,
											_p5._1,
											A2(
												_elm_lang$core$Result$withDefault,
												model.features,
												A3(_elm_community$intdict$IntDict_Safe$safeInsert, _p6, _p5._0, model.features)));
									},
									A2(
										_elm_lang$core$Maybe$map,
										_user$project$Feature$update(_p3._1),
										A2(
											_elm_lang$core$Result$withDefault,
											_elm_lang$core$Maybe$Nothing,
											A2(_elm_community$intdict$IntDict_Safe$safeGet, _p6, model.features)))))
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'FocusFeature':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Spec$focus(_p3._0)
				};
			case 'LoadSpec':
			...
			case 'SaveSpec':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Spec$saveSpec(
						A2(
							_user$project$Spec$SaveInfo,
							_p3._0,
							A2(
								_elm_lang$core$Json_Encode$encode,
								0,
								_user$project$Spec$encode(model))))
				};
			case 'EditTitle':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{isEditingTitle: true}),
					_1: _user$project$Spec$focus(_user$project$Spec$titleId)
				};
			case 'SubmitTitle':
				var _p7 = _p3._0;
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							title: (!_elm_lang$core$Native_Utils.eq(_p7, '')) ? _p7 : model.title,
			...
			case 'RequestRedraw':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: model.isEditingTitle ? _user$project$Spec$focus(_user$project$Spec$titleId) : _elm_lang$core$Platform_Cmd$none
				};
			case 'DiffSpec':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Spec$diffSpec(
						A2(
							_user$project$Spec$SaveInfo,
							_p3._0,
							A2(
...
var _user$project$Spec$NoOp = {ctor: 'NoOp'};
var _user$project$Spec$DiffSpec = function (a) {
	return {ctor: 'DiffSpec', _0: a};
};
var _user$project$Spec$RequestRedraw = {ctor: 'RequestRedraw'};
var _user$project$Spec$SubmitTitle = function (a) {
	return {ctor: 'SubmitTitle', _0: a};
};
var _user$project$Spec$EditTitle = {ctor: 'EditTitle'};
var _user$project$Spec$SaveSpec = function (a) {
	return {ctor: 'SaveSpec', _0: a};
};
var _user$project$Spec$LoadSpec = function (a) {
	return {ctor: 'LoadSpec', _0: a};
};
var _user$project$Spec$subscriptions = function (_p8) {
	var parseOpenedSpec = function (json) {
		return A2(
			_elm_lang$core$Result$withDefault,
			_user$project$Spec$NoOp,
			A2(
				_elm_lang$core$Result$map,
				_user$project$Spec$LoadSpec,
				A2(_elm_lang$core$Json_Decode$decodeString, _user$project$Spec$decoder, json)));
	};
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_user$project$UndoRedo$subMapNew, _user$project$Spec$loadSpec, parseOpenedSpec),
				A2(_user$project$UndoRedo$subMapNew, _user$project$Spec$saveSpecTrigger, _user$project$Spec$SaveSpec),
				A2(_user$project$UndoRedo$subMapNew, _user$project$Spec$diffSpecTrigger, _user$project$Spec$DiffSpec),
				A2(
				_user$project$UndoRedo$subMapNew,
				_user$project$Spec$requestRedraw,
				function (_p9) {
					return _user$project$Spec$RequestRedraw;
				}),
				_user$project$Spec$undo(
				function (_p10) {
					return _elm_community$undo_redo$UndoList$Undo;
				}),
				_user$project$Spec$redo(
				function (_p11) {
					return _elm_community$undo_redo$UndoList$Redo;
				})
			]));
};
var _user$project$Spec$FocusFeature = function (a) {
	return {ctor: 'FocusFeature', _0: a};
};
var _user$project$Spec$FeatureUpdate = F2(
	function (a, b) {
		return {ctor: 'FeatureUpdate', _0: a, _1: b};
	});
var _user$project$Spec$NewFeature = {ctor: 'NewFeature'};
var _user$project$Spec$view = function (_p12) {
	var _p13 = _p12;
	var _p15 = _p13.title;
	var _p14 = _p13.features;
	var featureButton = F2(
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('navbar-feature-button'),
								_elm_lang$html$Html_Events$onClick(
								_user$project$Spec$FocusFeature(
									_user$project$Feature$getId(index)))
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text(feature.name)
							]))
					]));
		});
	var viewTitle = _p13.isEditingTitle ? A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$class('title'),
						_elm_lang$html$Html_Attributes$id(_user$project$Spec$titleId),
						A2(
						_elm_lang$html$Html_Events$on,
						'blur',
						A2(_elm_lang$core$Json_Decode$map, _user$project$Spec$SubmitTitle, _elm_lang$html$Html_Events$targetValue)),
						A2(
						_elm_lang$html$Html_Events$on,
						'change',
						A2(_elm_lang$core$Json_Decode$map, _user$project$Spec$SubmitTitle, _elm_lang$html$Html_Events$targetValue)),
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('title'),
				_elm_lang$html$Html_Events$onClick(_user$project$Spec$EditTitle)
			]),
		_elm_lang$core$Native_List.fromArray(
			[
	...
	var viewFeature = F2(
		function (index, feature) {
			return A2(
				...
				_user$project$Spec$FeatureUpdate(index),
				_user$project$Feature$view(feature));
		});
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			...
			[
				...
				A2(
					...
					A2(
						...
						_elm_community$intdict$IntDict$values(
							A2(_elm_community$intdict$IntDict$map, viewFeature, _p14)),
						_elm_lang$core$Native_List.fromArray(
							[
								A2(
								_elm_lang$html$Html$div,
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$class('add-button-parent')
									]),
								_elm_lang$core$Native_List.fromArray(
									[
										A2(
										...
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html_Events$onClick(_user$project$Spec$NewFeature),
												_elm_lang$html$Html_Attributes$class('add-button')
											]),
										_elm_lang$core$Native_List.fromArray(
											[
												_elm_lang$html$Html$text('New Feature')
											]))
									]))
							])))),
				A2(
				...
				A2(
					...
					A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$class('navbar-title')
							]),
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html$text('Features')
							])),
					A2(
						_elm_lang$core$List_ops['::'],
						A2(
							...
							_elm_lang$core$Native_List.fromArray(
								[])),
						_elm_community$intdict$IntDict$values(
							A2(_elm_community$intdict$IntDict$map, featureButton, _p14)))))
			]));
};
var _user$project$Spec$main = {
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: _user$project$UndoRedo$initWithFlags(
				function (flags) {
					return {
						ctor: '_Tuple2',
						_0: _user$project$Spec$init(flags),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				}),
			view: _user$project$UndoRedo$view(
				function (_p16) {
					return A2(
						_elm_lang$html$Html_App$map,
						_elm_community$undo_redo$UndoList$New,
						_user$project$Spec$view(_p16));
				}),
			update: _user$project$UndoRedo$update(_user$project$Spec$update),
			subscriptions: _user$project$UndoRedo$subscriptions(_user$project$Spec$subscriptions)
		}),
...
var Elm = {};
Elm['Spec'] = Elm['Spec'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Spec'], 'Spec', typeof _user$project$Spec$main === 'undefined' ? null : _user$project$Spec$main);
